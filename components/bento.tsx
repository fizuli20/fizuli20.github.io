...
const STATS: StatCell[] = [
  ...
  },
  {
    ...
    numericValue: 1,
    decimals: 0,
    label: "ASPIRE (HBS) SEED FUND",
    detail: "$400 AWARD \u00b7 1 OF 40 FROM 1,800+ GLOBAL",
    visual: "fund",
    span: 1,
    skipCount: true,
  },
  {
    ...
    numericValue: 5,
    decimals: 0,
    label: "VENTURES CO-FOUNDED",
    detail: "AISE \u00b7 CARBORYN \u00b7 EARTHXLAB \u00b7 FVEDA \u00b7 HYPERAUTOMATION",
    visual: "ventures",
    span: 1,
  },
  {
  ...
  },
  {
    ...
    numericValue: 1,
    decimals: 0,
    label: "DELOITTE SR&T MENTEE",
    detail: "SUSTAINABILITY & CLIMATE ADVISORY",
    visual: "deloitte",
    span: 1,
    skipCount: true,
  },
